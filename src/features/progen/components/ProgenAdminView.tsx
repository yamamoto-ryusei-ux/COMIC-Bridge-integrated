...
import type { SymbolRule, ProofRule, ProofCategory, ProgenOptions, NumberRuleState } from "../progen";
import { EDIT_CATEGORIES, NUMBER_SUB_RULES, DEFAULT_SYMBOL_RULES, DEFAULT_OPTIONS, DEFAULT_NUMBER_RULES } from "../progen";
