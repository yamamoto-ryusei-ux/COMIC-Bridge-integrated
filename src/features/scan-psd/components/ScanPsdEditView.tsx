...
import { useProgenStore } from "../../progen/progenStore";
import { useScanPsdProcessor } from "../useScanPsdProcessor";
import type { ScanResult } from "../useScanPsdProcessor";
...
import { ProgenRuleView } from "../../progen/components/ProgenRuleView";
// 注意: ProgenProofreadingView は隔離済み（意図的にインポートしていません）。
// 校正は ProGen 画面の popup 方式（正誤+提案ボタン）で処理します。
// import { ProgenProofreadingView } from "../../progen/components/ProgenProofreadingView";
import { ProgenJsonBrowser } from "../../progen/components/ProgenJsonBrowser";
import { ProgenResultViewer } from "../../progen/components/ProgenResultViewer";
import { ProgenCalibrationSave } from "../../progen/components/ProgenCalibrationSave";
import type { PickedItem } from "../../progen/useProgenJson";
import ComicPotEditor from "../../progen/components/comicpot/ComicPotEditor";
